...
Last Modified : Tue 30 Jan 2018 05:13:30 PM EST
...
def plot_IOGC_poly(ax,fname):
    ...
    ax.add_collection(p)
    ax.annotate('IOGC',xy=(0.1,0.1),xytext=(0.01,0.14),size=14,
