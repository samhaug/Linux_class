...
Last Modified : Tue 23 Jan 2018 10:52:24 AM EST
...
for ii in range(num_files):
    ...
    #write an identical header for each file and then write the array beneath

    with open(random_directory+'/'+random_name,'w') as f:
        for lines in seed_header:
            f.write(lines)
        #fmt kwarg means three digit floating point with whitespace fill to 8
